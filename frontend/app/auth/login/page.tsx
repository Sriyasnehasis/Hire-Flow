...
import { Mail, Lock, Github, ArrowRight, Sparkles, CheckCircle2 } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <div className="orb orb-purple w-[400px] h-[400px] bottom-[-100px] right-[-100px] animate-pulse-glow" style={{ animationDelay: '2s' }} />
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-16 relative z-10">
        ...
        <div>
          <h2 className="text-5xl font-bold text-white leading-tight mb-8">
            Your dream career <br />starts with <span className="text-gradient italic">one</span> login.
          </h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-md">
          ...
          <p className="text-slate-400 mb-8">Sign in to your intelligence dashboard.</p>
